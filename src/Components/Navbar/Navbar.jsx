...
function Navbar() {
  ...
  return (
    <header className="header">
      <div className="logoDiv">
        <h1 className="logo">
          <a href="#home">Core Productions</a>
        </h1>
      </div>
          ...
          <ul className="navLists">
            <li className="navItem">
              <a href="#services" className="navLink">
                <span className="headerNumber">1.</span>About Us
              </a>
            </li>
            <li className="navItem">
            ...
            <li className="navItem">
              <a href="#testimonials" className="navLink">
                <span className="headerNumber">3.</span>Our Events
              </a>
            </li>
            <li className="navItem">
              <a href="#contact" className="navLink">
            ...
            <button className="btn">
              <a href="EventPlanningBrochure.pdf" download="EventPlanningBrochure.pdf">
                Brochure
              </a>
            </button>
          </ul>
  ...
  return (
    <div className="mobile navBar">
      <ul className="navLists">
        ...
        <li className="navItem">
          <a href="#portfolio" className="navLink">
            <span className="headerNumber">2.</span>Portfolio
          </a>
        </li>
        <li className="navItem">
          <a href="#testimonials" className="navLink">
